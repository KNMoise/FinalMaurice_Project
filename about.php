...
<body>
  <div class="container-xxl bg-white p-0" style="background-image: url('img/background.png'); background-size: cover; background-position: center; height: 300px; width: 100%;">
    <!-- Spinner Start -->
        ...
        <div class="container py-5 px-lg-5">
          <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <div class="skill mb-4">
                <div class="d-flex justify-content-between">
                  <p class="mb-2">Digital transformation</p>
                  <p class="mb-2">90%</p>
                </div>
                <div class="progress">
              ...
              <div class="skill mb-4">
                <div class="d-flex justify-content-between">
                  <p class="mb-2">Documents Management Solutions</p>
                  <p class="mb-2">95%</p>
                </div>
                <div class="progress">
